...
const source=fs.readFileSync(require.resolve('../../site/js/features/library/app.js'),'utf8');
...
function fixture(url){
 ...
 const c={URL,URLSearchParams,Dates:require('../../site/js/core/dates.js'),TIME_UNKNOWN:'undated',views:{papers:'Papers',timeline:'Timeline',reading:'Reading',topics:'Topics',about:'About',leaderboards:'Leaderboards'},state,location:{href:u.href,search:u.search,hash:u.hash}};
