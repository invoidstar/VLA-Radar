...
const C=require('../experience-core.js'),R=require('../research.js');
...
assert(fs.statSync('experience-loader.js').size<4000,'Eager loader budget');assert(fs.statSync('experience.js').size<60000,'Optional feature JS budget');assert(fs.statSync('experience.css').size<32000,'CSS budget');cases+=3;
