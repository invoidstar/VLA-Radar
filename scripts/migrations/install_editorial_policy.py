...
def install(root=ROOT):
    marker=root/'maintenance/policies/publishing-policy-applied.json'
    ...
    s=s.replace('maintenance/policies/content-standard.md,','maintenance/policies/content-standard.md, maintenance/policies/publishing-policy.md,')
...
'''
    ...
    p=root/'maintenance/policies/content-standard.md';s=p.read_text(encoding='utf-8')
    ...
    p.write_text(s,encoding='utf-8')
    (root/'maintenance/policies/publishing-policy.md').write_text(POLICY,encoding='utf-8')
