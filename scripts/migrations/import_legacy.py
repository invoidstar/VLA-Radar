...
MANIFEST = {
    ...
    'scripts/validate/validate_schema.py': 'd38db6e03a26c059307dee7f654ece9b26be13e7',
}
...
subprocess.run([sys.executable, str(ROOT / 'scripts/validate/validate_schema.py')], cwd=ROOT, check=True)
subprocess.run([sys.executable, str(ROOT / 'scripts/validate/check_catalog.py')], cwd=ROOT, check=True)
...
(ROOT / 'maintenance/audits/migrations/migration.json').write_text(json.dumps(report, ensure_ascii=False, indent=2) + '\n', encoding='utf-8')
