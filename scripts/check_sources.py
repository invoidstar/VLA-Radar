...
if __name__=='__main__':
    ap=argparse.ArgumentParser(description=__doc__);ap.add_argument('--root',type=Path,default=Path(__file__).resolve().parents[1]);ap.add_argument('--limit',type=int,default=100);ap.add_argument('--due-days',type=int,default=30);ap.add_argument('--max-seconds',type=int,default=180);a=ap.parse_args();audit(a.root,max(1,a.limit),a.due_days,max_seconds=a.max_seconds)
