...
try:
 ...
 with sync_playwright() as pw:
  ...
  yes('workspace export is a first-class sidebar action',page.locator('#workspace-export').get_attribute('aria-labelledby')=='export-title' and 'view=papers' not in page.url)
  page.locator('#export-close').click();yes('sidebar export closes without navigation',page.locator('#workspace-export[open]').count()==0)
