...
tracks=[
 ...
 T('dmsvla-2026-abstract-speed-range','DMS-VLA hardware','DMS-VLA · 正式摘要字面速度区间','IEEE RA-L 11(7), 2026','LIBERO/SIMPLER + real robot deployment','H100 / RTX4090 / Jetson AGX Orin headline','Literal endpoints of published abstract speedup string','score',['Printed lower endpoint','Printed upper endpoint'],'https://doi.org/10.1109/LRA.2026.3683324','正式摘要被索引为“25%-55%× inference speedups”。符号本身语义含混；本站只保存字面端点25/55，不解释为25x–55x或25%–55%统一加速。','正式摘要层证据；完整正文仍未取得。'),
...
rs += [
 ...
 R('r-dmsvla-abstract-range','p043','DMS-VLA','dmsvla-2026-abstract-speed-range',{'Printed lower endpoint':25.0,'Printed upper endpoint':55.0},'https://doi.org/10.1109/LRA.2026.3683324','IEEE RA-L 11(7), 2026','Published abstract','H100/RTX4090/Jetson headline','只存原摘要字符串端点；不把含混“25%-55%×”标准化成统一speedup。')
]
# ST-WAM
...
cfg={
 ...
 'p043':(['dmsvla-2026-abstract-speed-range'],1,None,None),
